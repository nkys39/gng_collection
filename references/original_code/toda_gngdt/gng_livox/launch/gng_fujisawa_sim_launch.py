...
def generate_launch_description():
    ...
    esslam_bringup_dir = os.path.join(get_package_share_directory('es_slam'))
    esslam_launch_file = os.path.join(esslam_bringup_dir,'launch', 'esslam_launch.py')
    ...
    esslam_launch_include = IncludeLaunchDescription(
        AnyLaunchDescriptionSource(esslam_launch_file),
    )
    ...
    # esslam起動設定
    ld.add_action(esslam_launch_include)
