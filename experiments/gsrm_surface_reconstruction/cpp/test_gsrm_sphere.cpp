/**
 * @file test_gsrm_sphere.cpp
 * @brief Test GSRM on sphere surface reconstruction (C++ implementation)
 *
 * Generates sphere point cloud, runs GSRM training,
...
int main(int argc, char* argv[]) {
    // Default parameters
    std::string output_dir = "gsrm_sphere_output";
    int n_samples = 5000;
    int n_iterations = 10000;
    unsigned int seed = 42;
    int frame_interval = 100;  // 10000/100 = 100 frames
    ...
    std::cout << "GSRM Sphere Surface Reconstruction Test (C++)\n";
    std::cout << "==============================================\n";
    ...
    std::cout << "Generating sphere point cloud...\n";
    auto samples = sampler_3d::sample_sphere(n_samples, 0.35f, 0.5f, 0.5f, 0.5f, seed);
    csv_writer::save_samples_3d(samples, output_dir + "/samples.csv");
    std::cout << "Generated " << samples.size() << " samples\n\n";

    // Setup GSRM parameters
