"""Test SOM (Self-Organizing Map) on single ring data with GIF visualization."""
...
def run_experiment(
    ...
    gif_frames: int = 100,
    output_gif: str = "som_single_ring_growth.gif",
    output_final: str = "som_single_ring_final.png",
    seed: int = 42,
    grid_size: int = 8,
) -> None:
    """Run SOM experiment."""
