/**
 * @file test_gng_kubota_triple_ring.cpp
 * @brief Test GNG Kubota (paper-compliant) on triple ring data
 *
...
void save_graph(const gng_kubota::GNGKubota<Eigen::Vector2f>& gng,
...
int main(int argc, char* argv[]) {
    std::string output_dir = "gng_kubota_triple_ring_output";
    int n_samples = 1500;
    ...
    std::cout << "GNG Kubota Triple Ring Test (C++)\n";
    std::cout << "==================================\n";
    ...
    gng_kubota::GNGKubotaParams params;
    ...
    std::cout << "GNG Kubota Parameters:\n";
    ...
    gng_kubota::GNGKubota<Eigen::Vector2f> model(params, seed);
    model.init();
    ...
    auto callback = [&](const gng_kubota::GNGKubota<Eigen::Vector2f>& gng, int iter) {
