/**
 * @file test_gngu2_triple_ring.cpp
 * @brief Test GNG-U2 on triple ring data (C++ implementation)
 */
...
void save_graph(const gng_u2::GNGU2_2f& model, const std::string& nodes_path, const std::string& edges_path) {
...
int main(int argc, char* argv[]) {
    std::string output_dir = "gngu2_triple_ring_output";
    int n_samples = 1500;
    ...
    std::cout << "GNG-U2 Triple Ring Test (C++)\n";
    std::cout << "=============================\n";
    ...
    // Setup GNG-U2 (parameters matching Python version)
    gng_u2::GNGU2Params params;
    ...
    params.chi = 0.005f;
    params.max_age = 88;
    params.utility_k = 1000.0f;  // For Euclidean distance
    params.kappa = 10;

    std::cout << "GNG-U2 Parameters:\n";
    ...
    gng_u2::GNGU2_2f model(params, seed);
    model.init();
    ...
    auto callback = [&](const gng_u2::GNGU2_2f& m, int iter) {
