/**
 * @file test_gng_triple_ring.cpp
 * @brief Test GNG on triple ring data (C++ implementation)
 *
 * Generates triple ring sample data, runs GNG training with 50,000 iterations,
...
int main(int argc, char* argv[]) {
    ...
    std::string output_dir = "triple_ring_output";
    int n_samples = 1500;
    int n_iterations = 50000;
    unsigned int seed = 42;
    int frame_interval = 500;  // Save every 500 iterations for ~100 frames
    ...
    std::cout << "GNG Triple Ring Test (C++)\n";
    std::cout << "==========================\n";
    ...
    // Setup GNG (paper parameters)
    gng::GNGParams params;
    params.max_nodes = 150;  // Allow more nodes for 50K iterations
    params.lambda = 100;
    params.eps_b = 0.08f;
    params.eps_n = 0.008f;
    params.alpha = 0.5f;
