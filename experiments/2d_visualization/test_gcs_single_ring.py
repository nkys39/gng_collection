"""Test GCS (Growing Cell Structures) on single ring data with GIF visualization."""
...
def run_experiment(
    ...
    gif_frames: int = 100,
    output_gif: str = "gcs_single_ring_growth.gif",
    output_final: str = "gcs_single_ring_final.png",
    seed: int = 42,
) -> None:
    """Run GCS experiment."""
    np.random.seed(seed)
