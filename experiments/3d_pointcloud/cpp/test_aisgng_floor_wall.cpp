/**
 * @file test_aisgng_floor_wall.cpp
 * @brief Test AiS-GNG on 3D floor and wall data (C++ implementation)
 */
...
int main(int argc, char* argv[]) {
    std::string output_dir = "aisgng_floor_wall_output";
    int n_samples = 2000;
    ...
    std::cout << "AiS-GNG 3D Floor+Wall Test (C++)\n";
    std::cout << "================================\n";
    ...
    auto callback = [&](const ais_gng::AiSGNG3f& gng, int iter) {
    ...
    metadata.add("algorithm", "AiS-GNG");
