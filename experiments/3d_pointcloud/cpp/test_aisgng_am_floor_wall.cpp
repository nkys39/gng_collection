/**
 * @file test_aisgng_am_floor_wall.cpp
 * @brief Test AiS-GNG-AM (Amount of Movement) on 3D floor and wall data (C++ implementation)
 *
 * SMC 2023 variant with Amount of Movement criterion.
 */
...
int main(int argc, char* argv[]) {
    std::string output_dir = "aisgng_am_floor_wall_output";
    int n_samples = 2000;
    ...
    std::cout << "AiS-GNG-AM 3D Floor+Wall Test (C++)\n";
    std::cout << "===================================\n";
    ...
    std::cout << "AiS-GNG-AM Parameters:\n";
    ...
    ais_gng_am::AiSGNGAM3f model(params, seed);
    model.init();
    ...
    auto callback = [&](const ais_gng_am::AiSGNGAM3f& gng, int iter) {
    ...
    metadata.add("algorithm", "AiS-GNG-AM");
