/**
 * @file test_aisgng_roman_floor_wall.cpp
 * @brief Test AiS-GNG-RO-MAN on 3D floor and wall data (C++ implementation)
 *
 * RO-MAN 2023 variant with simplified Add-if-Silent rule.
 */
...
int main(int argc, char* argv[]) {
    std::string output_dir = "aisgng_roman_floor_wall_output";
    int n_samples = 2000;
    ...
    std::cout << "AiS-GNG-RO-MAN 3D Floor+Wall Test (C++)\n";
    std::cout << "=======================================\n";
    ...
    auto callback = [&](const ais_gng_roman::AiSGNGRoman3f& gng, int iter) {
    ...
    metadata.add("algorithm", "AiS-GNG-RO-MAN");
