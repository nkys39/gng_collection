/**
 * @file gng_kubota.hpp
 * @brief Growing Neural Gas - Kubota paper-compliant implementation
 *
 * Based on:
...
namespace gng_kubota {

/**
 * @brief GNG Kubota hyperparameters.
 */
struct GNGKubotaParams {
    int max_nodes = 100;
    int lambda = 100;
    float eps_b = 0.08f;
    float eps_n = 0.008f;
...
public:
    ...
    using Callback = std::function<void(const GNGKubota&, int)>;

    GNGKubotaParams params;
...
public:
    explicit GNGKubota(const GNGKubotaParams& params = GNGKubotaParams(), unsigned int seed = 0)
        : params(params),
...
// Common type aliases
using GNGKubota2f = GNGKubota<Eigen::Vector2f>;
using GNGKubota3f = GNGKubota<Eigen::Vector3f>;
using GNGKubota2d = GNGKubota<Eigen::Vector2d>;
using GNGKubota3d = GNGKubota<Eigen::Vector3d>;
